...
<!-- banner -->
	<div class="banner">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="index.html" class="menu__link">Главная</a></li>
		...
		<div class="wthree_banner_info">
			<h2><span>CropSafe</span>Нужно что-то написать</h2>
			<div class="agileinfo_more">
				<a class="link link--kumya" href="#" data-toggle="modal" data-target="#myModal"><span data-letters="Подробнее">Подробнее</span></a>
			</div>
		</div>
	</div>
<!-- //banner -->
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						...
						<p>Тут очень много важной информации и очень содержательный текст отражающий всю суть решения
							<i>" А это цитата довольного пользователя."</i></p>
					</div>
				</section>
			</div>
		</div>
...
<!-- banner-bottom -->
	<div class="banner-bottom">
		<div class="container">
			<h3><span>CropSafe</span> Мы очень крутые и можем все! <span class="fixed_">Добавляйтесь</span></h3>
			<div class="agileits_banner_bottom_grids">
				<div class="col-md-3 agileits_banner_bottom_grid">
					<div class="hovereffect ls_banner_bottom_grid">
...
<!-- work -->
	<div class="work">
		<div class="container">
			<h3 class="header">Our <span>Work</span></h3>
		</div>
				...
				<div class="flexslider">
					<ul class="slides">
						...
						<li>
							...
							<div class="work_grid_right">
								<h4>Agriculture Lanscape</h4>
								<h5>Второй способ применения</h5>
								<p>Duis vitae faucibus quam. Sed tempus vestibulum lacus blandit faucibus. 
									Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, 
									at imperdiet urna. </p>
							</div>
						...
						<li>
							...
							<div class="work_grid_right">
								<h4>Agriculture Lanscape</h4>
								<h5>Третий способ применения</h5>
								<p>Duis vitae faucibus quam. Sed tempus vestibulum lacus blandit faucibus. 
									Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, 
									at imperdiet urna. </p>
							</div>
						...
						<li>
							...
							<div class="work_grid_right">
								<h4>Agriculture Lanscape</h4>
								<h5>Четвертый способ применения</h5>
								<p>Duis vitae faucibus quam. Sed tempus vestibulum lacus blandit faucibus. 
									Nunc imperdiet, diam nec rhoncus ullamcorper, nisl nulla suscipit ligula, 
									at imperdiet urna. </p>
							</div>
			...
			<div class="agile_team_grids">
				<div class="agile_team_grid">
					<div class="agile_team_text">
						<p>Очень крутые ребята. 
							Сэкономили 1 000 000 рублей.</p>
					</div>
					<div class="agileits_quotes">
						<h3>Michael Paul</h3>
						<p>Farmer</p>
					</div>
				</div>
...
<!-- testimonials -->
	<div class="testimonials">
		<div class="container">
			<h3 class="header agileits_header">Our <span>Testimonials</span></h3>
			<div class="wthree_testimoniagrids">
				<div class="col-md-6 wthree_testimoniagrid_left">
					<div class="ls_testimoniagrid_left_grid">
					...
					<div class="ls_testimoniagrid_left_grid testimoniagrid_left_grid">	
						<div class="col-xs-8 agileinfo_testimonials_right agileits_farm_man">
							<div class="agileits_testimonials_right_grid testimonials_right_grid">
				...
				<div class="col-md-6 wthree_testimoniagrid_right">
	...
	<div class="footer">
		<div class="container">
			...
			<div class="col-md-8 footer_grid">
				...
				<p>© 2017 CropSafe. All Rights Reserved | Design by <a href="http://talestorm.ru/" target="_blank">TaleStorm</a></p>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
